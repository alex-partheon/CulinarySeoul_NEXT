...
```bash
# .env.local
NEXT_PUBLIC_SUPABASE_URL=https://qcyksavfyzivprsxxxxxxase.co
NEXT_PUBLIC_SUPABASE_ANON_KEY=eyJhbGxxxxxxxxx444PNamiCM
SUPABASE_SERVICE_ROLE_KEY=eyJhbGciOiJIxxxxIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1MzE3NTI2NywiZXhwIjoyMDY4NzUxMjY3fQ.NRGB109uoMVElzOxhq5LiergzcWRC0uL0nlIBsNGdKY

# 개발 환경
NEXT_PUBLIC_SUPABASE_URL=https://qcyksavfxxxxxxxxase.co
NEXT_PUBLIC_SUPABASE_ANON_KEY=eyJhbGcixxxxxwicm9sZSI6ImFub24iLCJpYXQiOjE3NTMxNzUyNjcsImV4cCI6MjA2ODc1MTI2N30.0HAt8Cah3qSJTIedjRFghH819HUaoUoT-444PNamiCM
```
